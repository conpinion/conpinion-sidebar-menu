  ...
  grunt.initConfig({
    ...
    htmlbuild: {
      dist: {
        ...
        options: {
          scripts: {
            'conpinion-sidebar-item': ['build/conpinion-sidebar-item.js'],
            'conpinion-sidebar-menu': ['build/conpinion-sidebar-menu.js'],
            'conpinion-sidebar-submenu': ['build/conpinion-sidebar-submenu.js']
          },
          styles: {
          },
          data: {
